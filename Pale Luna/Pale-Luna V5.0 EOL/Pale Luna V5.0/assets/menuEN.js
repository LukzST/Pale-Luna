...
const mainMenuItems = [
    'START GAME', 'RESTART PROGRESS', 'ACHIEVEMENTS', 'OPTIONS',
    'CREDITS', 'SUPPORT', 'EXIT'
];
const settingsMenuItems = [
    'AUDIO', 'ACCOUNT', 'RESTORE DATA',
    'EASTER EGGS', 'MAIN MENU'
];
        ...
        if (currentMenu === 'main') {
            switch (selectedItem) {
                ...
                case 'ACHIEVEMENTS':
                    ...
                    break;
                case 'OPTIONS': // <<<<< CORREÇÃO APLICADA: Deve ser 'OPTIONS' para o menu principal
                    changeMenu('settings', settingsMenuItems, 'SETTINGS');
                    break;
                case 'CREDITS':
            ...
            switch (selectedItem) {
                case 'AUDIO': // CORREÇÃO: Você tinha 'Soundtrack' na lógica, mas a lista usa 'AUDIO'. Ajustei a lógica.
                    changeMenu('music', musicOptionItems, 'SOUNDTRACK');
                    break;
                case 'ACCOUNT': // CORREÇÃO: Você tinha 'Account Creation' na lógica, mas a lista usa 'ACCOUNT'. Ajustei a lógica.
                    ...
                    break;
                case 'RESTORE DATA': // CORREÇÃO: Você tinha 'Restore Endings' na lógica, mas a lista usa 'RESTORE DATA'. Ajustei a lógica.
                    changeMenu('restore', restoreMenuItems, 'RESTORE ENDINGS');
                    break;
                case 'EASTER EGGS': // CORREÇÃO: Você tinha 'Easter Eggs' (plural) na lógica, a lista usa EASTER EGGS. OK.
                    changeMenu('easterEggs', easterEggsMenuItems, 'EASTER EGGS');
                    break;
                case 'LANGUAGE':
                    changeMenu('language', languageMenuItems, 'LANGUAGE');
                    break;
                case 'MAIN MENU': // CORREÇÃO: Você tinha 'Back to main menu' na lógica, mas a lista usa 'MAIN MENU'. Ajustei a lógica.
                    changeMenu('main', mainMenuItems, 'MAIN MENU');
                    break;
            }
